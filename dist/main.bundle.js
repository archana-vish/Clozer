...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.toggle = function (index) {
        alert(index);
        //this.cnt = index;
        if (this.showDetails) {
            this.showDetails = false;
