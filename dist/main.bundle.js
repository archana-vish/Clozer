    ...
    SearchComponent.prototype.getSectorSearchResults = function (areaDetail) {
        ...
        setTimeout(function () {
            _this.searchAreaService.getSectorDetails(_this.searchModel).subscribe(function (sectorDetails) {
                ...
                _this.seachCriteria = 'Search by Facilities';
